...
- **Preprint**: [bioRxiv](https://www.biorxiv.org/content/10.1101/2025.10.21.683535v2)
...
```bibtex
@article {Toosi2025.10.21.683535,
    ...
    elocation-id = {2025.10.21.683535},
    year = {2025},
    doi = {10.1101/2025.10.21.683535},
    URL = {https://www.biorxiv.org/content/early/2025/10/23/2025.10.21.683535},
    eprint = {https://www.biorxiv.org/content/early/2025/10/23/2025.10.21.683535.full.pdf},
    journal = {bioRxiv}
}
```
...
```bash
git clone https://github.com/toosi/Generative_Inference_Perception.git
cd Generative_Inference_Perception
```
...
This work was supported by [acknowledgments can be added here].
